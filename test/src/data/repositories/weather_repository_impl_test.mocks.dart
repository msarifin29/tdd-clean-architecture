...
// in tdd_clean_architecture_app/test/src/data/repositories/weather_repository_impl_test.dart.
...
class MockRemoteDataSource extends _i1.Mock implements _i4.RemoteDataSource {
  ...
  @override
  _i5.Future<_i2.WeatherModel> getCurrentWeather(String? cityName) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCurrentWeather,
          [cityName],
